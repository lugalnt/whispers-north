...
func _ready():
	...
	# Conectar foco inicial para navegación con flechas
	connect("settings_menu_opened", _set_initial_focus)


## Establece el foco inicial para navegación por teclado cuando el menú se hace visible.
func _set_initial_focus() -> void:
	if SettingsTabsRef:
		SettingsTabsRef.grab_focus()
